...
var _camelizeStyleName = __webpack_require__(14);
...
var url = exports.url = 'https://raindays.cn/';
var hosts = exports.hosts = 'https://raindays.cn/';
var iframeHosts = exports.iframeHosts = 'https://raindays.cn/';
...
var _hash = __webpack_require__(22);
...
var _frame = __webpack_require__(37);
...
var _attach = __webpack_require__(36);
...
var NewFrame = exports.NewFrame = function NewFrame(props) {
  var _cx, _cx2, _cx3;
  ...
  var url = props.url,
      ...
      iframeStyle = props.iframeStyle,
      children = props.children,
      containerChildren = props.containerChildren;
  ...
  var onFrameClick = function onFrameClick() {
  ...
  (0, _react.useEffect)(function () {
    ...
    var _visibleRenderTimeout = setTimeout(function () {
      setIsVisible(true);
    }, delay);
    return function () {
...
var _dist = __webpack_require__(32);

var _settings = __webpack_require__(7);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

if (_dist.NewFrame.isReady()) {
  _dist.NewFrame.toggle();
} else {
  boot();
}
...
function boot() {
  ...
  var App =
  // <Frame url={url} />
  _react2.default.createElement(_dist.NewFrame, { url: _settings.url });
...
*/
var aa=__webpack_require__(9),m=__webpack_require__(0),r=__webpack_require__(61);function y(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}if(!aa)throw Error(y(227));var ba=new Set,ca={};function da(a,b){ea(a,b);ea(a+"Capture",b)}
 ...
 * LICENSE file in the root directory of this source tree.
 */
var l=__webpack_require__(0),n=60103,p=60106;exports.Fragment=60107;exports.StrictMode=60108;exports.Profiler=60114;var q=60109,r=60110,t=60112;exports.Suspense=60113;var u=60115,v=60116;
